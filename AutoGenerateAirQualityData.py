...
def randomValues():
    ...
    pm25_range = random.choices(
        [(0, 200), (200, 1000)], weights=(98, 2), k=1)
    ...
    no_range = random.choices(
        [(0, 50), (50, 100), (100, 500)], weights=(88, 10, 2), k=1)
    ...
    nh3_range = random.choices(
        [(0, 100), (100, 500)], weights=(98, 2), k=1)
    ...
    o3_range = random.choices(
        [(0, 50), (50, 100), (100, 500)], weights=(73, 25, 2), k=1)
    o3 = random.uniform(*o3_range[0])

    # Benzene
    benzene_range = random.choices(
        [(0, 20), (20, 500)], weights=(98, 2), k=1)
